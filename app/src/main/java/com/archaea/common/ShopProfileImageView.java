 ...
 */
public class ShopProfileImageView extends ImageView{
    ...
    public ShopProfileImageView(Context context) {
        this(context, null);
    }

    public ShopProfileImageView(Context context, AttributeSet attrs) {
